...
function preload() {
  ...
  backgroundMusic = loadSound("./assets/background_music.gif");
  waterSound = loadSound("./assets/cannon_water.gif");
  pirateLaughSound = loadSound("./assets/pirate_laugh.gif");
  cannonExplosion = loadSound("./assets/cannon_explosion.gif");
